...
<div style="width:90%; margin: 2em auto;">
	<a href="<?php print(_APP_URL); ?>/app/inna_chroniona.php" class="pure-button">kolejna chroniona strona</a>
	<a href="<?php print(_APP_URL); ?>/app/security/logout.php" class="pure-button pure-button-active">Wyloguj</a>
</div>

<div style="width:90%; margin: 2em auto;">

<form action="<?php print(_APP_URL); ?>/app/kalk_kred.php" method="get" class="pure-form pure-form-stacked">
