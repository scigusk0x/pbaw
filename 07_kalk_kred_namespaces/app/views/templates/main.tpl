    ...
    <div class="page">
        <div class="header">
            <div class="pure-menu pure-menu-horizontal">
              <a href="{$conf->action_url}startPageView" class="pure-menu-heading">Kalkulator kredytowy</a>
      
              <ul class="pure-menu-list">
                <li class="pure-menu-item {if $page_title=='Strona startowa'}pure-menu-selected{/if}">
                  <a href="{$conf->action_url}startPageView" class="pure-menu-link">
                ...
                <li class="pure-menu-item {if $page_title=='Kalkulator kredytowy'}pure-menu-selected{/if}">
                  <a href="{$conf->action_url}emptyCalcView" class="pure-menu-link">
